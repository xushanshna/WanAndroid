...
public class CircleImageView extends ImageView {
    ...
    private static final int DEFAULT_CIRCLE_BACKGROUND_COLOR = Color.TRANSPARENT;//默认背景色，透明
    private static final boolean DEFAULT_BORDER_OVERLAY = false;//默认边框不覆盖图片
